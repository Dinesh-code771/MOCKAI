...
import { getScheduledTests } from '@/app/dashboard/student/test/_actions';
import {
          ...
          <div className="flex flex-wrap gap-4 lg:flex-row flex-col">
            {cards.map((card, index) => {
              ...
              return (
                ...
                >
                  <Card
                    className="bg-white/70 backdrop-blur-lg max-h-50  border-white/20 cursor-pointer hover:shadow-lg transition-all duration-300"
                    onClick={() => router.push(card.href)}
                  >
                    <CardContent className="p-6">
                      <div
                        className={`inline-flex p-3 rounded-full bg-gradient-to-r ${card.color} mb-4`}
                      >
              ...
              <div className="flex flex-wrap gap-4">
                {achievements.map((achievement, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="flex items-center space-x-2 p-3 bg-gray-50/50 rounded-lg"
                    >
